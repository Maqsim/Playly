...
@objc public protocol SBObjectProtocol2: NSObjectProtocol {
    func get() -> Any!
}

@objc public protocol SBApplicationProtocol2: SBObjectProtocol2 {
    func activate()
...
@objc public protocol MusicApplication: SBApplicationProtocol2 {
